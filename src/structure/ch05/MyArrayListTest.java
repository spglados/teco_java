...
public class MyArrayListTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("값 추가 확인 : " + list); // list에 toString 재정의 되어있음 그래서 주소값이 안나옴
		...
		// 중복값일 경우 앞의 값이 적용됨 list는 중복값을 허용함
		...
		// 배열, ArrayList
		// 검색을 빠르게 해야 할때 -> 배열
		// 크기를 늘렸다 줄였다 많이 해야 할때 -> ArrayList
